...
// print a message
$txt = "Nama    : Tovard Linus\nBooking: 810\n\nPhone            : 08812318232\n\nAlamat    : Jombang";
$pdf->MultiCell(80, 80, $txt, 0, 'J', false, 75, 75, 30, true, 40, false, true, 40, 'T', true);
...
$pdf->write2DBarcode('www.tcpdf.org', 'QRCODE,Q', 20, 30, 50, 50, $style, 'N');
$pdf->Text(20, 25, 'Code Bookin RS');
